...
public class TweakerooUtils {
    ...
    /** Uses Tweakeroo's configured threshold for client-predicted break packets. */
    public static int getSafeBreakBudget(ItemStack stack) {
        ...
        return Math.max(0, remainingDurability - getMinimumDurability(stack));
    }

    private static int getMinimumDurability(ItemStack stack) {
