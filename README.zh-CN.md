...
> 连续完整建造 **10 次**（视频中没有全部展示）：**0次幽灵方块 和 0 次构建错误（包括方向错误）**。
> 构建19187个方块只花费了0.12~0.18秒。

https://github.com/user-attachments/assets/16d21510-265b-43f8-b619-16f749202998

> 测试对象：**图书馆**（从一个不记得名字和作者的地图中保存的）
> 尺寸 47 × 18 × 31，共 **6766** 个方块。
> 连续完整建造 **2 次**（全部在视频中）：**0次幽灵方块 和 0 次构建错误（包括方向错误）**。
> 构建6766个方块只花费了0.05~0.06秒。
